...
[
  ...
  poisoned-slownless-tick-count; determines slownless ticks count after poisoning
]

fruit-bushes-own
[
  amount ; amount of energy in bush
  poisoned ; determines whether bush poiosned or not
]
...
[
  ...
  poisoned-death-count; total of deaths from poisoned bushes
  ...
  poisoned-death-rate; rate of deaths from poisoned bushes
...
to setup ; initial setup
  ...
  [
    ...
    set age 0
    set poisoned-slownless-tick-count 0
  ]
  set total-population 0
  set murder-count 0
  set death-count 0
  set poisoned-death-count 0
  set murder-rate 0
...
"Poisoned" 1.0 0 -2139308 true "" "plot poisoned-death-rate"
...
288
776
strength-value-resistent-to-poison
strength-value-resistent-to-poison
0
100
0.0
